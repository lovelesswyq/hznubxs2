...
class studyPublishedManager(models.Manager):
    def get_queryset(self):
        return super(studyPublishedManager,
...
class Study(models.Model):
    ...
    published = studyPublishedManager() # Our custom manager.
    
    def get_absolute_url(self):
        return reverse('study:study_detail',
...
class studyComment(models.Model):
    post = models.ForeignKey(Study, related_name='comments')
